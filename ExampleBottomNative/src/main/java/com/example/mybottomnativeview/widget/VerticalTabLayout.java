...
public class VerticalTabLayout extends NestedScrollView {
    ...
    private void initTabWithMode(LinearLayout.LayoutParams params) {
        if (mTabMode == TAB_MODE_FIXED) {
            ...
            params.weight = 0f;
            params.setMargins(0, mTabMargin, 0, mTabMargin);
...
//    }
    ...
    public void clearTabSelectedListener(){
    ...
    private class TabStrip extends LinearLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (mIndicatorCorners != 0) {
                ...
                canvas.drawLine(mIndicatorX+mIndicatorWidth,mIndicatorTopY,
                        mIndicatorX + mIndicatorWidth,mIndicatorBottomY,paint);
            }
        }
